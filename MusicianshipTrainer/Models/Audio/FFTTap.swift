...
//        let frameCount:UInt32 = UInt32(buffer.count) + UInt32(buffer.count) * zeroPaddingFactor
...
//        let windowSize = Int(buffer.count)
...
//        var bufferFloat:[Float] = []
//       for d in buffer {
//           bufferFloat.append(Float(d))
//       }
//        vDSP_vmul(bufferFloat, 1, window,
//                 1, &transferBuffer, 1, vDSP_Length(windowSize))
//
